...
ConfigBoard.prototype.initCanvasPos = function () {
    ...
    var _left = left + this.editBoard.canvas.width + 20;
    var _top = top;
    var f_style =  this.canvasCtnEl.getAttribute('style');
    this.elFrameBlock.setAttribute('style', f_style + ' left: '+_left+'px;top:'+_top+'px;');
};
...
ConfigBoard.prototype.resetCanvas = function () {
    ...
    var _left = left + this.editBoard.canvas.width + 20;
    var _top = top;
    this.elFrameBlock.style.top = _top + 'px';
    this.elFrameBlock.style.left = _left + 'px';
};
...
ConfigBoard.prototype.zoomOutCanvas = function () {
    ...
    if(this.canvasCtner.offsetWidth > 2900){
